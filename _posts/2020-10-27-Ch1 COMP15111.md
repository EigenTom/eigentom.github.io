...
![20201105185759](https://raw.githubusercontent.com/KirisameMarisaa/KirisameMarisaa.github.io/master/img/blogpost_images/20201105185759.png) 


例: 执行三个数之间的加法 (未优化寄存器使用) 

![20201105185833](https://raw.githubusercontent.com/KirisameMarisaa/KirisameMarisaa.github.io/master/img/blogpost_images/20201105185833.png)
...
![20201105185910](https://raw.githubusercontent.com/KirisameMarisaa/KirisameMarisaa.github.io/master/img/blogpost_images/20201105185910.png)
...
* 条件分支
  ...
  ![20201105185947](https://raw.githubusercontent.com/KirisameMarisaa/KirisameMarisaa.github.io/master/img/blogpost_images/20201105185947.png)
  ...
  除了内建的 $16$ 个寄存器, `ARM` 架构还额外定义了一个大小为 `1bit` 的 **状态位 (`Status Flags`)**. 当前处理器状态寄存器 `(Current Processor Status Register)` 是一个记录当前处理器状态的寄存器. 它包含了一些状态位:
    ...
    ![20201105190018](https://raw.githubusercontent.com/KirisameMarisaa/KirisameMarisaa.github.io/master/img/blogpost_images/20201105190018.png)
  ...
  我们目前只关注状态位的以下四种状态:
    ...
    ![](https://raw.githubusercontent.com/KirisameMarisaa/KirisameMarisaa.github.io/master/img/blogpost_images/20201105190226.png)  
