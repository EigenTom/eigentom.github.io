...
date:       2021-11-11
author:     R1NG
header-img: img/post-bg-candc++.jpg
...
![20220503215834](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503215834.png)

![20220503215842](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503215842.png)

![20220503215928](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503215928.png)

![20220503215949](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503215949.png)

![20220503220002](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503220002.png)
...
![20220503220044](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503220044.png)

![20220503220054](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503220054.png)

![20220503220111](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503220111.png)

![20220503220136](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503220136.png)

![20220503220156](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503220156.png)

($\uparrow$ 注意 `C` 结构体没有 `C++` 那种乱七八糟的对齐优化)

![20220503220249](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503220249.png)

![20220503220306](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503220306.png)

($\uparrow$ 注意指针数据类型的位数就是计算机硬件位数: $32$ 位机指针大小 $4$ 字节 $4*8=32$ 位, $64$ 位机指针大小 $8$ 字节 $8*8=64$ 位)

![20220503220426](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503220426.png)

( $\uparrow$ 注意 $0$ 被解释为 `False`, 非负整数被解释为 `True`)

![20220503220548](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503220548.png)
...
![20220503220708](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503220708.png)

![20220503220724](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503220724.png)

![20220503220734](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503220734.png)

($\uparrow$ 回忆 **十六进制** (`Hexadecimal`) 表示方式)

![20220503220811](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503220811.png)

![20220503220835](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503220835.png)

($\uparrow$ 注意一下, 不过应该不考)

![20220503220903](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503220903.png)

($\uparrow$ 注意用法: 1. 注意表示微秒用.06 2. `timersub(后, 前, 结构体名)`)

![20220503221022](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503221022.png)

($\uparrow$ 回忆 `C/C++` 函数传参方式)

![20220503221103](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503221103.png)

($\uparrow$ 回忆 `C/C++` 变量存储方式: 全局变量总在static, 函数内啥东西都在stack里, 动态分配空间放heap)

![20220503221154](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503221154.png)
...
![20220503205449](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503205449.png)

![20220503205514](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503205514.png)

![20220503205552](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503205552.png)

![20220503205703](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503205703.png)

![20220503205722](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503205722.png)
...
![20220503192606](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503192606.png)
...
![20220503192810](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503192810.png)

具体地, 隐式类型转换的原则如下:

1. 若算式中变量 **类型一致**, 则不执行任何类型转换. 
2. 若算式中变量 **类型不一致**:
   1. 若在是否有符号性质上保持一致, 则 **低阶类型的变量类型被转换为高阶类型**.
   2. 若算式中存在比 **其他的有符号数据类型都高阶的** 无符号数据类型, 则有符号数据类型被转换为那个无符号数据类型. 
   3. 若存在某个有符号数据类型 **可以表示所有无符号数据类型表示的数据**, 则这些无符号数据类型统一被提升为这个有符号数据类型.
   4. 在其他情况下, 所有参与计算的变量都被转为无符号类型. 

需要注意 `C/C++` 在大部分情况下试图将有符号数据类型转为无符号数据类型的原因: 如果不考虑负数, 同级别的无符号数据类型所能存储的非负整数的范围是有符号数据类型的两倍. 

`C/C++` 中的隐式类型转换在一些特定情况下可能会出现问题:

![20220503193734](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503193734.png)

同时隐式类型转换还可以结合变量数据存储位数溢出问题共同在一些特定情况下对计算结果产生更恶劣的影响:

![20220503193925](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503193925.png)

在上面的例子中, 基于隐式类型转换规则, 一个有符号整数和一个无符号整数的加法中, 参与运算的两个变量`i` 的类型会被隐式转换为无符号整数. 而由于被当成无符号整数的 `i` 和 `ui` 相加后结果溢出无符号整数的表示范围: $4$ 字节 $4*8 = 32$ 位, 因此由于 **现代计算机使用小端序解析数据**, 左侧视为高位, 右侧视为低位, 因此只会取实际二进制加法结果 **从右往左数** 的总共 $32$ 位, 溢出的位被丢弃, 因此得到的结果是错误的. 
 
同时隐式类型转换在格式化输出中也可能存在:

![20220503194346](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503194346.png)
...
![20220503194705](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503194705.png)

#### 强制类型转换

除了不受控制的隐式类型转换外, `C/C++` 还提供了 **强制类型转换** 方法, 关键字为 `(type)expression`. 

![20220503194801](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503194801.png)

再来看一个指针巧妙应用的例子: 我们还可以使用 **通用指针 `void *`** 向函数中传入 **任何类型** 的数据:

![20220503195007](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503195007.png)
...
1. 高度贴近硬件底层, 调用系统功能时需要途径的中间层更少
2. 不存在任何会延长程序执行时间的内存垃圾回收机制 (这是好事, 也是坏事...)
3. 可以高效轻松地和汇编语言集成
4. 为程序员提供了直接控制内存布局的方法和手段

因此它们非常适合应用于高性能计算领域: 

![20220503195500](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503195500.png)

首先回顾基本的计算机存储架构层级:

![20220503195527](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503195527.png)

在下面的初始例子中, 使用如下图所示的结构体定义会导致每个结构体实例的大小为 `72` 位, 大于计算机缓存位数 `64` 位, 而且不是它的整数倍, 因此在调用结构体内数据时往往需要从主存中获取两个缓存位.

![20220503195827](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503195827.png)

而在 `C/C++` 中, 我们可以通过控制结构体占用内存大小为 `64` 的整数倍的方式通过减少调用它时所需获取的缓存位数来提升性能.

![20220503195953](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503195953.png)
...
![20220503200220](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503200220.png)

在下面的例子中我们简要观察 `Musl` 中对标准格式化输出函数 `printf` 的实现:

任何需要调用操作系统提供的服务的程序都需要通过 **`System Call`** 调用它们. 一般 `System Call` 是被 `C/C++` 标准库所直接调用的. 

![20220503200435](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503200435.png)

![20220503200448](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503200448.png)

![20220503200511](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503200511.png)

![20220503200531](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503200531.png)

![20220503200551](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503200551.png)

![20220503200609](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503200609.png)

实际上也可以编写程序直接调用 `System Call` 执行输出:

![20220503200645](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503200645.png)

~~(这个部分应该不考...)~~

注意:

1. During the execution of printf, Musl uses writev to write to the file descriptor corresponding to the standard output.

2. On x86-64, when we invoke a system call with 3 arguments, the registers used to pass these parameters and in  order: `%rdi, %rsi, then %rdx`.
 
3. By convention, up to 6 arguments for system calls are passed in order in `%rdi, %rsi, %rdx, %r10, %r8, and %r9`.

[REFERENCE](https://stackoverflow.com/questions/2535989/what-are-the-calling-conventions-for-unix-linux-system-calls-and-user-space-f)



### 相关题目解析

![20220503213114](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503213114.png)

![20220503213207](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503213207.png)

($\uparrow$ 补码表示法决定这个数是 $-2147483648$)

![20220503213253](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503213253.png)

($\uparrow$ 只是单纯的小端序 + 溢出)

![20220503213326](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503213326.png)

![20220503213346](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503213346.png)

![20220503213407](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503213407.png)

![20220503213448](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503213448.png)

![20220503213507](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503213507.png)

($\uparrow$ 这个应该全选)

![20220503213531](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503213531.png)
...
![20220503200810](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503200810.png)

下面考虑一个简单的操作系统 (`HermiTux`) 中对 `System Call` 和 `Context Switch` 的实现:

![20220503213953](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503213953.png)
...
![20220503214146](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503214146.png)

![20220503214229](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503214229.png)

![20220503214320](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503214320.png)

### 内存安全

`C/C++` 天生就是 **内存不安全** 的, 这是其贯彻高效和接近底层的设计思想带来的代价. 由于内存中存储信息的改变会直接影响程序的运行行为, 且程序在运行时不存在任何类型的内存检查机制, 我们需要格外注意 `C/C++` 中的内存安全问题. 

![20220503214654](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503214654.png)
...
![20220503225414](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503225414.png)

![20220503225444](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503225444.png)
...
![20220503225942](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503225942.png)
...
![20220503230357](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503230357.png)

如下图所示, 在执行从 `f()` 到 `g()` 的跳转时, 计算机首先会将 `f()` 当前使用的所有数据全部推入栈中, 然后存入在 `g()` 执行完后要跳转回来继续执行的下一条指令的内存地址:

![20220503230856](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503230856.png)

然后处理器就会跳转执行关于 `g()` 的指令, 在这过程中和 `g()` 相关的数据使用会利用堆栈的剩余部分. 

在 `g()` 执行完了之后, 与它相关的数据会从堆栈中被清除, 此时处理器会从栈中弹出原来推入的分支返回地址, 然后跳转执行该内存地址对应的指令.

![20220503231050](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503231050.png)

考虑下面的例子:

![20220503231202](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503231202.png)
...
![20220503231942](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503231942.png)

![20220503232000](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503232000.png)
...
![20220503232418](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503232418.png)
...
![20220503233029](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503233029.png)

### `C/C++` 中内存安全的合理实践

在上一节中, 我们已经了解到 `C/C++` 内存不安全的特性, 我们可以通过在编程中应用 **合理实践** 避免常见的, 导致内存不安全的问题出现. 

![20220503215032](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503215032.png)

我们首先可以使用多种分析工具对我们的程序进行内存安全分析: 

![20220503215052](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503215052.png)

但最重要的还是使用 **合理的实践和良好的风格** 编程:

![20220503215129](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503215129.png)

避免 `Undefined Behavior`:

![20220503215150](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503215150.png)

1. 控制数组/`Buffer` 的大小, 注意数据的长度和类型转换问题, 从而避免整数溢出问题:

![20220503215237](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503215237.png)

2. 避免使用下列的 **内存不安全** 的函数:

![20220503215318](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503215318.png)

3. 使用 **内存安全的字符串操作函数**:

![20220503215351](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503215351.png)

4. 在动态内存分配时检查 `malloc` 返回值, 避免间接引用或直接引用被销毁的指针, 谨慎使用 **不会销毁旧指针** 的 `realloc(ptr, new_size)` 方法:

![20220503215539](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503215539.png)

### 相关题目解析

![20220503233446](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503233446.png)

($\uparrow$ 被 NULL 覆写, 丢失引用, 再也无法释放指针指向的buffer)

![20220503233540](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503233540.png)

![20220503233551](https://cdn.jsdelivr.net/gh/KirisameR/KirisameR.github.io/img/blogpost_images/20220503233551.png)
