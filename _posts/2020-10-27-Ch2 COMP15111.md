...
![picture 1](../../images/4874531196513caf66939a12a93614c1ea2ea7119e6dcfcd903a221a64465429.png)  

而该程序的内存分配如下:

![picture 2](../../images/9b93ad2c20a440cf3aae416a30d90fa709b373bf7213377eab0e8171c14f66b0.png)  
...
![picture 3](../../images/dcd6a35b264d753d8a52ee3ba5ec81c22d9c26f6000338961b6097bd22cfa00f.png)  
可见, 通过优化, 我们成功地将涉及三个数的加法运算所需要使用的寄存器数量减少了 $5$ 个, 并且所执行指令的数量并没有增加. 这意味着, 程序运行时间和程序寄存器占用都得到了优化. 

下面再看一个例子:

![picture 4](../../images/d46c6465a31d37fb372af9423d389cb6f8b102b407e43a48ebbc67da4374f3ab.png)  
